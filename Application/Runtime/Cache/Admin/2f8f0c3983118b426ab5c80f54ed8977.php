            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_8780__=1;$__FOR_END_8780__=70;for($i=$__FOR_START_8780__;$i < $__FOR_END_8780__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Manager/index">管理员列表</a><span class="crumb-step">&gt;</span><span>修改权限</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Auth/saveauth/id/<?php echo ($id); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th width="10%">角色名：</th>
                                <td>
                                    <input class="common-text required" id="title" size="50" value="<?php echo ($data["title"]); ?>" type="text" disabled='disabled'>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <th></th>
                            <td class="labelBlock">
                               <?php if(is_array($ruleAll)): $i = 0; $__LIST__ = $ruleAll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(in_array($vo['id'],$rules)): ?><label><input type="checkbox" value="<?php echo ($vo["id"]); ?>" name="rules[]" checked='checked'>&nbsp;<?php echo ($vo["title"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <?php else: ?>
                                    <label><input type="checkbox" value="<?php echo ($vo["id"]); ?>" name="rules[]">&nbsp;<?php echo ($vo["title"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;</label><?php endif; endforeach; endif; else: echo "" ;endif; ?> 
                            </td>
                        </tr>
