            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        <?php $__FOR_START_29034__=1;$__FOR_END_29034__=70;for($i=$__FOR_START_29034__;$i < $__FOR_END_29034__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Manager/index">管理员列表</a><span class="crumb-step">&gt;</span><span>修改管理员密码</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Manager/savepwd/id/<?php echo ($user["id"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" value="<?php echo ($user["username"]); ?>" disabled='disabled' type="text">
                                </td>
                            </tr>
                            <tr>
