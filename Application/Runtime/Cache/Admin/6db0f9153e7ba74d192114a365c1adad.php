            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        <?php $__FOR_START_4647__=1;$__FOR_END_4647__=70;for($i=$__FOR_START_4647__;$i < $__FOR_END_4647__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Manager/index">管理员列表</a><span class="crumb-step">&gt;</span><span>修改管理员权限</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Manager/saveauth/id/<?php echo ($id); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" value="<?php echo ($username); ?>" disabled='disabled'  type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>权限分配：</th>
                                <td>
                                    <label><input type="radio" name="group_id" value="1" <?php echo ($user['group_id'] == 1?checked :''); ?>>超级管理员&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <label><input type="radio" name="group_id" value="2" <?php echo ($user['group_id'] == 2?checked :''); ?>>管理员&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <label><input type="radio" name="group_id" value="3" <?php echo ($user['group_id'] == 3?checked :''); ?>>编辑&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <label><input type="radio" name="group_id" value="4" <?php echo ($user['group_id'] == 4?checked :''); ?>>打杂&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                </td>
                            </tr>
