            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_29311__=1;$__FOR_END_29311__=70;for($i=$__FOR_START_29311__;$i < $__FOR_END_29311__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">角色列表页</span></div>
        </div>
        
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Auth/addRole"><i class="icon-font"></i>添加权限角色</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="/Admin/Auth/modauth/id/<?php echo ($vo["id"]); ?>">修改角色权限</a><span class="spanGray">|</span><a onclick="return confirm(' 你确定要删除吗？')" href="/Admin/Auth/deleteRole/id/<?php echo ($vo["id"]); ?>">删除角色</a></td>
