            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_27682__=1;$__FOR_END_27682__=70;for($i=$__FOR_START_27682__;$i < $__FOR_END_27682__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员列表</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/Admin/Manager/index" name="searchform" method="get">
        ...
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Manager/add"><i class="icon-font"></i>添加管理员</a>
                    </div>
                </div>
                <div class="result-content">
                <form name="myform" action="/Admin/Manager/deleteall" id="myform" method="post">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($u)): foreach($u as $key=>$v): ?><tr>
                                ...
                                <td><?php echo ($v["disabled"]); ?></td>
                                <td>
                                    <a href="/Admin/Manager/save/id/<?php echo ($v["id"]); ?>">修改</a><span class="spanGray">|</span>
                                    <a href="/Admin/Manager/changepwd/id/<?php echo ($v["id"]); ?>">修改密码</a><span class="spanGray">|</span>
                                    <a href="/Admin/Manager/changeauth/id/<?php echo ($v["id"]); ?>/username/<?php echo ($v["username"]); ?>">修改权限</a><span class="spanGray">|</span>
                                    <a onclick="return confirm(' 你确定要删除吗？')" href="<?php echo U('del','id='.$v['id']);?>">删除</a>
                                </td>
