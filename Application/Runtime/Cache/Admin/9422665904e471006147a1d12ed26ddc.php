            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_728__=1;$__FOR_END_728__=70;for($i=$__FOR_START_728__;$i < $__FOR_END_728__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">评价管理列表</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/Admin/Comment/index" name="searchform" method="get">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="请输入评价内容" name="keywords" value="<?php echo ($keywords); ?>" id="" type="text"></td>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($u)): foreach($u as $key=>$v): ?><tr>
                                ...
                                <td>
                                    ...
                                    <a href="/Admin/Comment/edit/id/<?php echo ($v["id"]); ?>">修改评论</a><span class="spanGray">|</span>
                                    <a onclick="return confirm(' 你确定要删除吗？')" href="/Admin/Comment/delete/id/<?php echo ($v["id"]); ?>">删除</a>
                                </td>
