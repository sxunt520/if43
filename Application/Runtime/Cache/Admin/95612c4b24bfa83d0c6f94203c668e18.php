            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        <?php $__FOR_START_15261__=1;$__FOR_END_15261__=70;for($i=$__FOR_START_15261__;$i < $__FOR_END_15261__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Category/index">精品分类</a><span class="crumb-step">&gt;</span><span>添加分类</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Category/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th>是否显示：</th>
                                <td><label><input type="radio" name="is_show" value="1" checked="true"> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="is_show" value="0"> 否</label></td>
                            </tr>
                             <tr>
                                <th>是否推荐：</th>
                                <td><label><input type="radio" name="is_tj" value="1"> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="is_tj" value="0" checked="true"> 否</label></td>
                            </tr>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="cat_desc" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>排序：</th>
                                <td>
                                    <input class="common-text required" name="sort_order" size="10" value="100" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
