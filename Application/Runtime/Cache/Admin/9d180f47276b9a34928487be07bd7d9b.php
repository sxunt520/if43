            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_5811__=1;$__FOR_END_5811__=70;for($i=$__FOR_START_5811__;$i < $__FOR_END_5811__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员权限列表页</span></div>
        </div>
        
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Auth/add"><i class="icon-font"></i>添加管理员权</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($ruleAll)): $i = 0; $__LIST__ = $ruleAll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($vo["id"]); ?></td>
                                <td><?php echo ($vo["name"]); ?></td>
                                <td><?php echo ($vo["title"]); ?></td>
                                <td><a href="/Admin/Auth/authEdit/id/<?php echo ($vo["id"]); ?>">修改权限</a><span class="spanGray">|</span><a onclick="return confirm(' 你确定要删除吗？')" href="/Admin/Auth/delete/id/<?php echo ($vo["id"]); ?>">删除权限</a></td>
