            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        <?php $__FOR_START_10862__=1;$__FOR_END_10862__=70;for($i=$__FOR_START_10862__;$i < $__FOR_END_10862__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Manager/index">广告类型</a><span class="crumb-step">&gt;</span><span>添加广告类型</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/AdvType/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        
                            <tr>
                                <th width="10%"><i class="require-red">*</i>广告类型名：</th>
                                <td>
                                    <input class="common-text required" id="title" name="type_name" size="30" value="" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th width="10%"><i class="require-red">*</i>宽：</th>
                                <td>
                                    <input class="common-text required" id="title" name="width" size="10" value="" type="text">&nbsp;&nbsp;px
                                </td>
                            </tr>
                            
                            <tr>
                                <th width="10%"><i class="require-red">*</i>高：</th>
                                <td>
                                    <input class="common-text required" id="title" name="height" size="10" value="" type="text">&nbsp;&nbsp;px
                                </td>
                            </tr>
