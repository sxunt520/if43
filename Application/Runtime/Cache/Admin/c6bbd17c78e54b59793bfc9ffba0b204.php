            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_19095__=1;$__FOR_END_19095__=70;for($i=$__FOR_START_19095__;$i < $__FOR_END_19095__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Pro/edit/pro_id/66" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                ...
                                <div class="controls">
                                        <select style="height:30px;" id="p" name="first">
                                            ...
                                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cat_id']); ?>" <?php if($vo['cat_id'] == $cat_id['first']): ?>selected='selected'<?php else: endif; ?>><?php echo ($vo['cat_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        <select style="height:30px;" id="c" name="second">
                                            <option value="">二级分类</option>
                                            <?php if(is_array($data2)): $i = 0; $__LIST__ = $data2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cat_id']); ?>" <?php if($vo['cat_id'] == $cat_id['second']): ?>selected='selected'<?php else: endif; ?>><?php echo ($vo['cat_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        <select style="height:30px;" name="cid" id="d">
                                            <option value="">三级分类</option>
                                            <?php if(is_array($data3)): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cat_id']); ?>" <?php if($vo['cat_id'] == $cat_id['cid']): ?>selected='selected'<?php else: endif; ?>><?php echo ($vo['cat_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>					
                                        </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required"  name="pro_name" size="30" value="<?php echo ($row["pro_name"]); ?>" type="text">&nbsp;&nbsp;最多12字
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>标题：</th>
                                <td>
                                    <input class="common-text required" name="pro_title" size="50" value="<?php echo ($row["pro_title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>简单描述：</th>
                                <td><textarea name="pro_desc" class="common-textarea" cols="30" style="width: 98%;" rows="5"><?php echo ($row["pro_desc"]); ?></textarea></td>
                            </tr>
                           <tr>
                                ...
                                <td>
                                    <select name="type_id" id="type_id" class="required">
                                        ...
                                        <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["type_id"]); ?>" <?php if($vo['type_id'] == $row['type_id']): ?>selected='selected'<?php else: ?>disabled='disabled'<?php endif; ?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                      	   </tr>
                           <tr>
                           ...
                           <tr>
                                <th>价格：</th>
                                <td>
                                    <input class="common-text required" name="pro_price" size="5" value="<?php echo ($row["pro_price"]); ?>" type="text" onfocus="if (this.value == '<?php echo ($row["pro_price"]); ?>'){this.value='';}" onblur="if (this.value == ''){this.value='<?php echo ($row["pro_price"]); ?>';}">&nbsp;￥
                                </td>
                            </tr>
                            <tr>
                                <th>价格趋势：</th>
                                <td>
                                    <input class="common-text required"  name="price_trend" size="10" value="<?php echo ($row["price_trend"]); ?>" type="text" onfocus="if (this.value == '<?php echo ($row["price_trend"]); ?>'){this.value='';}" onblur="if (this.value == ''){this.value='<?php echo ($row["price_trend"]); ?>';}">&nbsp;如"89%"，这里填"89".
                                </td>
                            </tr>
                            <tr>
                                <th>去购买：</th>
                                <td>
                                    <input class="common-text required" name="buy_url" size="50" value="<?php echo ($row["buy_url"]); ?>" type="text">&nbsp;电商平台外链接 http://
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>缩略图：</th>
                                <td>
                                <img src="/Public/uploads/<?php echo ($row["img120x120"]); ?>" style="margin:10px 0;"/>
                            ...
                            <tr>
                                ...
                                <td>
                                <img src="/Public/uploads/<?php echo ($row["img_new"]); ?>" height="120" style="margin:10px 0;"/>
                        ...
                        <table width="100%" id="gallery-table" class="insert-tab">
                              ...
                              <tr>
                              	<td>
                                  <div class="galaryBox">
                                      <?php if(is_array($galary)): $i = 0; $__LIST__ = $galary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl id="imgDl_<?php echo ($vo["img_id"]); ?>">
                                                <dt>
                                              <a href="javascript:void(0);" title="删除" class="deleteImg" onclick="deleteImg('<?php echo ($vo["img_id"]); ?>')"><i class="icon-font">&#xe069;</i></a>
                                                    <img src="/Public/uploads/<?php echo ($vo["thumb_url"]); ?>" width="150"/>
                                                </dt>
                                                <dd><input type="text" name="galary[<?php echo ($vo["img_id"]); ?>]" class="galaryText" value="<?php echo ($vo["img_desc"]); ?>"/></dd>
                         ...
                         <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                <th>加入推荐：</th>
                                <td>
                    <label><input type="checkbox" name="is_new" value="1" <?php if($row['is_new'] == 1 ): ?>checked='checked'<?php else: endif; ?>>&nbsp;新品&nbsp;&nbsp; </label>
                    <label><input type="checkbox" name="is_examine" value="1" <?php if($row['is_examine'] == 1 ): ?>checked='checked'<?php else: endif; ?>>&nbsp;审核&nbsp;&nbsp;</label>
                    <label><input type="checkbox" name="is_best" value="1" <?php if($row['is_best'] == 1 ): ?>checked='checked'<?php else: endif; ?>>&nbsp;精品&nbsp;&nbsp;</label>
                    <label><input type="checkbox" name="is_hot" value="1" <?php if($row['is_hot'] == 1 ): ?>checked='checked'<?php else: endif; ?>>&nbsp;火热&nbsp;&nbsp;</label>
                    <label><input type="checkbox" name="is_onsale" value="1"  <?php if($row['is_onsale'] == 1 ): ?>checked='checked'<?php else: endif; ?>>&nbsp;上架</label>
                                </td>
                            </tr>
                            <tr>
                                <th>排序：</th>
                                <td>
                                    <input class="common-text required" name="pro_order" size="50" value="<?php echo ($row["pro_order"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>添加时间：</th>
                                <td>
                                    <input class="common-text required" id="datetimepicker_mask" name="add_time" size="50" value="<?php echo (date("Y/m/d h:m",$row["add_time"])); ?>" type="text">
                                </td>
                            </tr>
                                <tr>
                                    <th width="100"></th>
...
<script>
	...
	function deleteImg(img_id) {
		// 当前的ID
		var url = "/Admin/Pro/deleteImg/img_id/"+img_id; 
		$.get(url,'',function(data) {
	...
	window.onload = function() {
		var url = "/Admin/Attribute/editAttrs/type_id/<?php echo ($row['type_id']); ?>/pro_id/<?php echo ($row['pro_id']); ?>"; 
		$.get(url,'',function(data) {
				$("#tbody-goodsAttr").empty();
				$("#tbody-goodsAttr").append(data);
		});
