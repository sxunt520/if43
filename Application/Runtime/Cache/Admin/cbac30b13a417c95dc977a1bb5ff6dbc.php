            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_1245__=1;$__FOR_END_1245__=70;for($i=$__FOR_START_1245__;$i < $__FOR_END_1245__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Member/index">会员列表</a><span class="crumb-step">&gt;</span><span>添加会员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Member/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="phone" size="30" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="password" size="30" type="password"></td>
                            </tr>
                            <!--<tr>
                                <th><i class="require-red">*</i>确认密码：</th>
                                <td>
                                    <input class="common-text required" id="title" name="conf_password" size="30" value="" type="password">
                                </td>
                            </tr>-->
                            <tr>
                                <th>邮箱：</th>
                                <td><input class="common-text" name="email" size="30" type="text"></td>
                            </tr>
                            <tr>
                                <th>头像：</th>
                                <td>
                                    <input name="person_img" type="file">请上传<span class="fuchsia">180x180</span>的个人形像靓一张!
                                </td>
                            </tr>
                            <tr>
                                <th>性别：</th>
