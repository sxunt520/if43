            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_25712__=1;$__FOR_END_25712__=70;for($i=$__FOR_START_25712__;$i < $__FOR_END_25712__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">广告列表</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/Admin/Adv/index/type_id/0" name="type_id" method="get">
        ...
        <script type="text/javascript">
			function searchAttr(type_id) {
			  window.location.href = "/Admin/Adv/index/type_id/"+ type_id;
			}
		</script>
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Adv/add/type_id/<?php echo ($type_id); ?>"><i class="icon-font"></i>添加广告</a>
                    </div>
                </div>
                <div class="result-content">
                <form name="myform" action="/Admin/Adv/deleteall" id="myform" method="post">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><img src="/Public/uploads/<?php echo ($v["advimg"]); ?>" width="100" /></td>
                                <td><?php echo ($v["jumpurl"]); ?></td>
                                <td><?php echo ($v["advorder"]); ?></td>
                                <td><?php if($v["is_show"] == '1' ): ?><i class="icon-font">&#xe068;</i><?php else: ?><i class="icon-font">&#xe069;</i><?php endif; ?></td>
                                <td>
                                    <a href="/Admin/Adv/edit/id/<?php echo ($v["id"]); ?>">修改</a><span class="spanGray">|</span>
                                    <a onclick="return confirm(' 你确定要删除吗？')" href="/Admin/Adv/delete/id/<?php echo ($v["id"]); ?>">删除</a>
                                </td>
