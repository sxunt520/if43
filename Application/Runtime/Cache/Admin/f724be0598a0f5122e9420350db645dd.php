            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        <?php $__FOR_START_10859__=1;$__FOR_END_10859__=70;for($i=$__FOR_START_10859__;$i < $__FOR_END_10859__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Admin/Manager/index">权限列表</a><span class="crumb-step">&gt;</span><span>添加管理权限</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Admin/Auth/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
