            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu"  style="display:none;">
                        ...
                        <?php $__FOR_START_3515__=1;$__FOR_END_3515__=70;for($i=$__FOR_START_3515__;$i < $__FOR_END_3515__;$i+=1){ ?><li><a href="system.html"><i class="icon-font">&#xe0<?php echo ($i); ?>;</i><?php echo ($i); ?></a></li><?php } ?>
                    </ul>
                </li>
            </ul>
...
<div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="/Admin/Comment/index">评价管理列表</a></span>&gt;</span><span class="crumb-name">评价回复列表</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/Admin/Comment/reply/id/151" name="searchform" method="get">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="请输入回复内容" name="keywords" value="<?php echo ($keywords); ?>" id="" type="text"></td>
        ...
        <div class="result-wrap">
                <!--<div class="result-title">
                    <div class="result-list">
                        <a href="/Admin/Comment/add"><i class="icon-font"></i>添加评价</a>
                    </div>
                </div>-->
                <div class="result-content">
                <form name="myform" action="/Admin/Comment/deleteall" id="myform" method="post">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if($total == 0): ?><tr><td colspan="10"><span class="fuchsia">暂无回复</span></td></tr><?php else: ?>
                        <?php if(is_array($u)): foreach($u as $key=>$v): ?><tr>
                                <td class="tc"><input name="id[]" value="<?php echo ($v["id"]); ?>" type="checkbox"></td>
                                <td><?php echo ($v["id"]); ?></td>
                                <td><a href="/Home/Detail/index/pro_id/<?php echo ($v["pro_id"]); ?>" target="_blank"><?php echo ($v["pro_id"]); ?></a></td>
                                <td><?php echo ($v["uid"]); ?></td>
                                <td><?php echo ($v["username"]); ?></td>
                                <td><img src="/Public/uploads/<?php echo ($v["img180x180"]); ?>" width="40"/></td>
                                <td><?php echo ($v["content"]); ?></td>
                                <td><?php if($v['is_show'] == 1): ?><i class="icon-font greed">&#xe068;</i><?php else: ?><i class="icon-font red">&#xe069;</i><?php endif; ?></td>
                                <td><?php echo (date("Y/m/d h:m",$v["time"])); ?></td>
                                <td>
                                	<!--<a href="/Admin/Comment/reply/id/<?php echo ($v["id"]); ?>">查看回复</a><span class="spanGray">|</span>-->
                                    <a href="/Admin/Comment/editReply/id/<?php echo ($v["id"]); ?>/pid/<?php echo ($v["pid"]); ?>">修改回复</a><span class="spanGray">|</span>
                                    <a onclick="return confirm(' 你确定要删除吗？')" href="/Admin/Comment/deleteReply/id/<?php echo ($v["id"]); ?>/pid/<?php echo ($v["pid"]); ?>">删除</a>
                                </td>
                        ...
                        <div class="checkAll">
                            ...
                            <input type="submit" name="action" value="已审核">
                            <input type="submit" name="action" value="未审核">
                        </div>      
