...
<div id="container">
	<div class="content">
        ...
        <form id="registerForm" method="post" action="/Home/Reg/reg" enctype="multipart/form-data">
                    <div class="form-row">
                    <label>手机号：</label>
                    <input class="base-input" id="mobile" name="phone" type="text">
                    <span class="tel_icon"></span>
                    </div>
                    <div class="form-row">
                    <label>账号：</label>
                    <input class="base-input" id="nickname" name="username" type="text">
                    <span class="user_icon"></span>
                    </div>
					<div class="form-row">
                    <label>密码：</label>
                    <input class="base-input" id="password" name="password" type="password">
                    <span class="pwd_icon"></span>
					</div>
					<div class="form-row">
                    <label>确认密码：</label>
                    <input class="base-input" id="conf_password" name="conf_password" value="" type="password">
                    <span class="pwd_icon"></span>
					</div>
                    <p class="otherInfo">其它信息</p>
                    <div class="form-row">
                    <label>邮箱：</label>
                    <input class="base-input" name="email" type="text">
                    </div>
                    <div class="form-row">
                    <label>头像：</label>
                    ...
                    <label>&nbsp;</label>
                    <input class="bbl-btn submit reg_btn_wrap" value="立即注册" type="submit">
                    </div>
					<div class="form-row">
						<label>&nbsp;</label>
						<input class="check" name="remember" value="1" checked="checked" type="checkbox">
						<span class="agreement gc6">我已阅读并同意<a href="/Home/Reg/agreement" target="_blank">《使用协议》</a></span>
					</div>
				</form>	
		</div>		
	</div><!--content end-->
...
<script>
  var url1= "/Home/Reg/regajaxphone";
  var url2= "/Home/Reg/regajaxuser";
  var url3= "/Home/Reg/check_verify";
</script>
</body>
</html>