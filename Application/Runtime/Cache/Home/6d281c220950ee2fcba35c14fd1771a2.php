...
<?php if(CONTROLLER_NAME== 'Clothes'){ ?><!--如果控制器是衣服频道显示这里-->
		<div class="fl cate_main_box" style="background-image:url(/Public/uploads/<?php echo ($catBg["advimg"]); ?>);">
			<div class="cate_main_tag_box bigfs">
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/5">上装</a></h3>
                <div class="sub_tag_box clearfix">
                <!--如果被先中添加class="emphasize" 如果有星星添加标签<em>*</em>-->
                
                <?php if(is_array($subCat1)): $i = 0; $__LIST__ = $subCat1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                
                </div>
                </div>
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/7">裙子</a></h3>
                <div class="sub_tag_box clearfix">
                
                <?php if(is_array($subCat3)): $i = 0; $__LIST__ = $subCat3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>

                </div>
                </div>
                    <div class="tag_unit">
                     <h3><a href="/Home/Clothes/prolist/cat_id/6">裤子</a></h3>
                        <div class="sub_tag_box clearfix">
                      
                            <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 <?php if(CONTROLLER_NAME == 'Shoe'){ ?><!--如果控制器是鞋子频道显示这里-->
		<div class="fl cate_main_box" style="background-image:url(/Public/uploads/<?php echo ($catBg["advimg"]); ?>);">
			<div class="cate_main_tag_box bigfs">
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/47">款式</a></h3>
                <div class="sub_tag_box clearfix">
                <!--如果被先中添加class="emphasize" 如果有星星添加标签<em>*</em>-->
                ...
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/48">元素</a></h3>
                <div class="sub_tag_box clearfix">
                ...
                <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="tag_unit">
                     <h3><a href="/Home/Clothes/prolist/#tagB">潮流风格</a></h3>
                        <div class="sub_tag_box clearfix">
                      
                            <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo == $fg): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/fg/<?php echo ($vo); ?>"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 <?php } ?>   
  ...
  <?php if(CONTROLLER_NAME == 'Bag'){ ?><!--如果控制器是包包频道显示这里-->
		<div class="fl cate_main_box" style="background-image:url(/Public/uploads/<?php echo ($catBg["advimg"]); ?>);">
			<div class="cate_main_tag_box bigfs">
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/86">款式</a></h3>
                <div class="sub_tag_box clearfix">
                <!--如果被先中添加class="emphasize" 如果有星星添加标签<em>*</em>-->
                ...
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/88">流行</a></h3>
                <div class="sub_tag_box clearfix">
                ...
                <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="tag_unit">
                     <h3><a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/cz/all">材质</a></h3>
                        <div class="sub_tag_box clearfix">
                      
                            <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo == $cz): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/cz/<?php echo ($vo); ?>"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 <?php } ?>
  ...
  <?php if(CONTROLLER_NAME == 'Acc'){ ?><!--如果控制器是配饰频道显示这里-->
		<div class="fl cate_main_box" style="background-image:url(/Public/uploads/<?php echo ($catBg["advimg"]); ?>);">
			<div class="cate_main_tag_box bigfs">
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/128">首饰</a></h3>
                <div class="sub_tag_box clearfix">
                <!--如果被先中添加class="emphasize" 如果有星星添加标签<em>*</em>-->
                ...
                <div class="tag_unit">
                <h3><a href="/Home/Clothes/prolist/cat_id/129">装扮</a></h3>
                <div class="sub_tag_box clearfix">
                ...
                <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="fl <?php if($vo['cat_id'] == $cat_id): ?>emphasize<?php else: endif; ?>" href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); if($vo['is_tj'] == 1): ?><em>*</em><?php else: endif; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="tag_unit">
                     <h3><a href="/Home/Clothes/prolist/#tagB">材质</a></h3>
                        <div class="sub_tag_box clearfix">
 ...
 <?php } ?>
		...
		<div class="fr cate_sidebar">
			<div class="relative_tag_box">
				<h2 class="bigfs"><span class="mr15">[</span>当季<em>衣服</em>推荐<span class="ml15">]</span></h2>
				<div class="relative_tag_a_box bigfs mt5">
                        
                        <?php if(is_array($tj1)): $i = 0; $__LIST__ = $tj1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/Home/Clothes/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="find_sort_box clearfix">
        <h3 class="fl"><a href="/Home/Clothes/prolist/cat_id/<?php echo ($nowCatName["cat_id"]); ?>"><?php echo ($nowCatName["cat_name"]); ?></a></h3>
        <span class="fs14 ml5 mr5 fl">&gt;</span>
            <div class="sort_unit fl ml40">
            <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/hot/priceTop/<?php echo ($priceTop); ?>/#tagB" <?php if($top == 'hot' ): ?>class='on'<?php else: endif; ?>>热门</a>|
            <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/new/priceTop/<?php echo ($priceTop); ?>/#tagB" <?php if($top == 'new' ): ?>class='on'<?php else: endif; ?>>最新</a>
            </div>
         <div class="range-box">
            <form method="get" action="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/#tagB" class="showHide">
              <!--这里被选择中添加class="on"-->
                 <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/all/#tagB" <?php if($priceTop == 'all' ): ?>class='on'<?php else: endif; ?>>全部</a>|
                 <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/100/#tagB" <?php if($priceTop == '100' ): ?>class='on'<?php else: endif; ?>>100元</a>|
                 <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/200/#tagB" <?php if($priceTop == '200' ): ?>class='on'<?php else: endif; ?>>200元</a>|
                 <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300/#tagB" <?php if($priceTop == '300' ): ?>class='on'<?php else: endif; ?>>300元</a>|
                 <a href="/Home/Clothes/prolist/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300x/#tagB" <?php if($priceTop == '300x' ): ?>class='on'<?php else: endif; ?>>300以上</a>|
