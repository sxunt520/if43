...
<!-------------------------top_End------------------------->
		<div id="container">
			<div class="content clearfix">
					...
					<div class="set-box">
						<h2 class="findH2">重设密码</h2>
                        <p>亲爱的<span class="fuchsia">"<?php echo ($_SESSION['findinfo']['username']); ?>"</span>用户为你现在可以为你自己重设密码!</p>
						<div class="set-password">

						<form action="/Home/Login/doupdate" id="J_PwdEmail" class="set-form" method="post">
							<div class="form-row clearfix">
								<label style="width:110px;">新密码：</label>
								<input name="pwd" class="base-input" type="password">
							</div>
							<div class="form-row clearfix">
								<label style="width:110px;">确认新密码：</label>
								<input name="repwd" class="base-input" type="password">
							</div>
                            <div class="form-row clearfix">
							...
							<div class="form-row">
								...
								<input class="bbl-btn submit" value="修改" type="submit">
                                <input type="hidden" value="<?php echo ($_SESSION['findinfo']['id']); ?>" name="id">
							</div>
						</form>
						</div>
					</div>
