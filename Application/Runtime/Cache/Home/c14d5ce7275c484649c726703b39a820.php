	...
	<div class="clearfix find_top_box">
		<div class="find_top_left fl">
                            <div class="unit clearfix ">
                                <span class="category fl"><a href="/Home/Shoe/prolist/cat_id/47">款&nbsp;&nbsp;&nbsp;&nbsp;式</a></span>
                                <div class="tag_box fr">
                                    <?php if(is_array($subCat1)): $i = 0; $__LIST__ = $subCat1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/Home/Shoe/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" <?php if($vo['is_tj'] == 1): ?>class="on"<?php else: endif; ?>><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                                <div class="unit clearfix ">
                                   	 <span class="category fl"><a href="/Home/Shoe/prolist/cat_id/48">元&nbsp;&nbsp;&nbsp;&nbsp;素</a></span>
                                    <div class="tag_box fr">
                                        <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/Home/Shoe/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" <?php if($vo['is_tj'] == 1): ?>class="on"<?php else: endif; ?>><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                <div class="unit clearfix ">
                                    <span class="category fl"><a href="#tagB">潮流风格</a></span>
                                    <div class="tag_box fr">
                                     <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item" href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($vo); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="find_top_right fr">
                        ...
                        <?php if(is_array($proRows1)): $i = 0; $__LIST__ = $proRows1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="unit fl">
                                ...
                                <div class="fl ml5" style="width:100px; overflow:hidden; height:47px;">
                                     <a class="pinkc mt5" href="/Home/Shoe/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" target="_blank"><?php echo ($vo["cat_name"]); ?></a>
		...
		<div class="faxian_g_icon faxian_top_nav_cur"></div>
			<h2 class="bigfs">小编精选鞋子推荐</h2>
                    ...
                    <?php if(is_array($proRows3)): $i = 0; $__LIST__ = $proRows3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 5 );++$i;?><div class="unit fl <?php if(($mod) == "4"): ?>last<?php endif; ?>">
                            ...
                            <div class="faxian_g_icon faxian_tag_mask bigfs"><?php echo ($i); echo ($vo["cat_name"]); ?></div>
            ...
            <div class="cate_top">
                    ...
                    <h3 class="fl bigfs">热门品类</h3>
                        <div class="unit_fr fr">
                        	<a class="tag-item  <?php if($cat_id == 2): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/2/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB">全部</a>
                            <?php if(is_array($tj1)): $i = 0; $__LIST__ = $tj1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item  <?php if($vo['cat_id'] == $cat_id): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/<?php echo ($vo["cat_id"]); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                          </div>
                    </div>
						<div class="unit clearfix">
						<h3 class="fl bigfs">潮流风格</h3>
                        <div class="unit_fr fr">
                        		<a class="tag-item  <?php if($fg == 'all'): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/all/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB">全部</a>
                                <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item  <?php if($vo == $fg): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($vo); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
						<div class="unit clearfix">
                        <h3 class="fl bigfs">适用场景</h3>
                        <div class="unit_fr fr">
                        			<a class="tag-item <?php if($cj == 'all'): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/all#tagB">全部</a>
                                    <?php if(is_array($subCat4)): $i = 0; $__LIST__ = array_slice($subCat4,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item <?php if($vo == $cj): ?>on<?php else: endif; ?>" href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($vo); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                           </div>
                      </div>
	
        <div class="find_sort_box clearfix">
        <h3 class="fl"><a href="/Home/Shoe/index/cat_id/<?php echo ($nowCatName["cat_id"]); ?>/#tagB"><?php echo ($nowCatName["cat_name"]); ?></a></h3>
        <span class="fs14 ml5 mr5 fl">&gt;</span>
            <div class="sort_unit fl ml40">
            <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/hot/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($top == 'hot' ): ?>class='on'<?php else: endif; ?>>热门</a>|
            <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/new/priceTop/<?php echo ($priceTop); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($top == 'new' ): ?>class='on'<?php else: endif; ?>>最新</a>
            </div>
         <div class="range-box">
            <form method="get" action="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" class="showHide">
              <!--这里被选择中添加class="on"-->
 <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/all/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == 'all' ): ?>class='on'<?php else: endif; ?>>全部</a>|
 <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/100/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '100' ): ?>class='on'<?php else: endif; ?>>100元</a>|
 <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/200/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '200' ): ?>class='on'<?php else: endif; ?>>200元</a>|
 <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '300' ): ?>class='on'<?php else: endif; ?>>300元</a>|
 <a href="/Home/Shoe/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300x/fg/<?php echo ($fg); ?>/fashion/<?php echo ($fashion); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '300x' ): ?>class='on'<?php else: endif; ?>>300以上</a>|
