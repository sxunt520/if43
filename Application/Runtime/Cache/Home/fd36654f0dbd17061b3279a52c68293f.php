	...
	<div class="clearfix find_top_box">
		<div class="find_top_left fl">
                            <div class="unit clearfix ">
                                <span class="category fl"><a href="/Home/Bag/prolist/cat_id/86">款&nbsp;&nbsp;&nbsp;&nbsp;式</a></span>
                                <div class="tag_box fr">
                                    <?php if(is_array($subCat1)): $i = 0; $__LIST__ = $subCat1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/Home/Bag/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" <?php if($vo['is_tj'] == 1): ?>class="on"<?php else: endif; ?>><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                                <div class="unit clearfix ">
                                   	 <span class="category fl"><a href="/Home/Bag/prolist/cat_id/88">流&nbsp;&nbsp;&nbsp;&nbsp;行</a></span>
                                    <div class="tag_box fr">
                                        <?php if(is_array($subCat2)): $i = 0; $__LIST__ = $subCat2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/Home/Bag/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" <?php if($vo['is_tj'] == 1): ?>class="on"<?php else: endif; ?>><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                <div class="unit clearfix ">
                                    <span class="category fl"><a href="#tagB">材&nbsp;&nbsp;&nbsp;&nbsp;质</a></span>
                                    <div class="tag_box fr">
                                     <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($vo); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                <div class="unit clearfix last">
                                    <span class="category fl"><a href="#tagB">适用场景</a></span>
                                    <div class="tag_box fr">
                                        <?php if(is_array($subCat4)): $i = 0; $__LIST__ = $subCat4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($vo); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
								</div>
                    <div class="find_top_right fr">
                        ...
                        <?php if(is_array($proRows1)): $i = 0; $__LIST__ = $proRows1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="unit fl">
                                ...
                                <div class="fl ml5" style="width:100px; overflow:hidden; height:47px;">
                                     <a class="pinkc mt5" href="/Home/Bag/prolist/cat_id/<?php echo ($vo["cat_id"]); ?>" target="_blank"><?php echo ($vo["cat_name"]); ?></a>
		...
		<div class="faxian_g_icon faxian_top_nav_cur"></div>
			<h2 class="bigfs">小编精选包包推荐</h2>
                    ...
                    <?php if(is_array($proRows3)): $i = 0; $__LIST__ = $proRows3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 5 );++$i;?><div class="unit fl <?php if(($mod) == "4"): ?>last<?php endif; ?>">
                            ...
                            <a href="/Home/Bag/prolist/cat_id<?php echo ($vo["cat_id"]); ?>/" target="_blank"><?php echo ($vo["cat_name"]); ?></a>
                            </div>
            ...
            <div class="cate_top">
                    ...
                    <h3 class="fl bigfs">热门品类</h3>
                        <div class="unit_fr fr">
                        	<a class="tag-item  <?php if($cat_id == 3): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/3/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB">全部</a>
                            <?php if(is_array($tj1)): $i = 0; $__LIST__ = $tj1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item  <?php if($vo['cat_id'] == $cat_id): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($vo["cat_id"]); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                          </div>
                    </div>
                    	<div class="unit clearfix">
						<h3 class="fl bigfs">材质</h3>
                        <div class="unit_fr fr">
                        		<a class="tag-item  <?php if($cz == 'all'): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/all/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB">全部</a>
                                <?php if(is_array($subCat3)): $i = 0; $__LIST__ = array_slice($subCat3,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item  <?php if($vo == $cz): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($vo); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
						<div class="unit clearfix">
						<h3 class="fl bigfs">潮流风格</h3>
                        <div class="unit_fr fr">
                        		<a class="tag-item  <?php if($fg == 'all'): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/all/cj/<?php echo ($cj); ?>#tagB">全部</a>
                                <?php if(is_array($subCat5)): $i = 0; $__LIST__ = array_slice($subCat5,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item  <?php if($vo == $fg): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($vo); ?>/cj/<?php echo ($cj); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
						<div class="unit clearfix">
                        <h3 class="fl bigfs">适用场景</h3>
                        <div class="unit_fr fr">
                        			<a class="tag-item <?php if($cj == 'all'): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/all#tagB">全部</a>
                                    <?php if(is_array($subCat4)): $i = 0; $__LIST__ = array_slice($subCat4,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="tag-item <?php if($vo == $cj): ?>on<?php else: endif; ?>" href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($vo); ?>#tagB"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                           </div>
                      </div>
	
        <div class="find_sort_box clearfix">
        <h3 class="fl"><a href="/Home/Bag/index/cat_id/<?php echo ($nowCatName["cat_id"]); ?>/#tagB"><?php echo ($nowCatName["cat_name"]); ?></a></h3>
        <span class="fs14 ml5 mr5 fl">&gt;</span>
            <div class="sort_unit fl ml40">
            <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/hot/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($top == 'hot' ): ?>class='on'<?php else: endif; ?>>热门</a>|
            <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/new/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($top == 'new' ): ?>class='on'<?php else: endif; ?>>最新</a>
            </div>
         <div class="range-box">
            <form method="get" action="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/<?php echo ($priceTop); ?>/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" class="showHide">
              <!--这里被选择中添加class="on"-->
 <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/all/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == 'all' ): ?>class='on'<?php else: endif; ?>>全部</a>|
 <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/100/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '100' ): ?>class='on'<?php else: endif; ?>>100元</a>|
 <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/200/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '200' ): ?>class='on'<?php else: endif; ?>>200元</a>|
 <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '300' ): ?>class='on'<?php else: endif; ?>>300元</a>|
 <a href="/Home/Bag/index/cat_id/<?php echo ($cat_id); ?>/top/<?php echo ($top); ?>/priceTop/300x/cz/<?php echo ($cz); ?>/fg/<?php echo ($fg); ?>/cj/<?php echo ($cj); ?>#tagB" <?php if($priceTop == '300x' ): ?>class='on'<?php else: endif; ?>>300以上</a>|
